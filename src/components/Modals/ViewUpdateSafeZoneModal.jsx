...
const ViewUpdateSafeZoneModal = ({ isOpen, onClose, zoneId, onSave }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center bg-black bg-opacity-50 pt-32">
      <div className="w-full max-w-xl bg-white bg-opacity-90 rounded-lg shadow-lg p-6 relative">
        <h2 className="text-4xl font-bold mb-6 text-gray-900 text-center">View / Update Safe Zone</h2>
