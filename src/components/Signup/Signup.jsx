      ...
      >
        ...
        <Card className="w-full max-w-md p-6 rounded-lg bg-white bg-opacity-90 shadow-lg">
          <form className="w-full" onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              <Typography variant="h4" className="font-medium text-black mb-1 pr-96">Username</Typography>
            ...
            <div className="mb-4 flex items-center">
              ...
              />
              <label htmlFor="isAdmin" className="ms-2 text-sm font-medium text-gray-900 dark:text-black">Rendre Admin</label>
            </div>
